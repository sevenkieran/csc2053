def most_popular_foods(fav_foods):
    ...
    """
    popular_foods = {}
    for name in fav_foods:
        if fav_foods[name] not in popular_foods:
            tmp_list = []
            tmp_list.append(name)
            popular_foods[fav_foods[name]] = tmp_list
        else:
            popular_foods[fav_foods[name]].append(name)

    return popular_foods


assert most_popular_foods(
    fav_foods={
        "Kathleen": "pizza",
        "Steve": "burger",
        "John": "steak",
    ...
    "pizza": ["Kathleen", "Patrick"],
    "burger": ["Steve"],
    "steak": ["John"],
    "pasta": ["Michelle"],
}, "expected {'pizza': ['Kathleen', 'Patrick'], 'burger': ['Steve'], 'steak': ['John'], 'pasta': ['Michelle']}"
print("correct")
assert most_popular_foods(
    {"Kathleen": "pizza", "Yin": "pizza", "Kearicia": "Italian", "Owen": "burgers"}
) == {
    "pizza": ["Kathleen", "Yin"],
    "Italian": ["Kearicia"],
    "burgers": ["Owen"],
}, "expected {'pizza': ['Kathleen', 'Yin'], 'Italian': ['Kearicia'], 'burgers': ['Owen']}"
print("correct")
assert most_popular_foods(
    {
        "Kathleen": "pizza",
    ...
    "pizza": ["Kathleen", "Andy"],
    "burgers": ["Max", "Matt", "Christina"],
}, "expected {'pizza': ['Kathleen', 'Andy'], 'burgers': ['Matt','Max','Christina']}"
print("correct")
